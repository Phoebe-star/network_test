...
tf.flags.DEFINE_string('logs_dir', 'logs_mobile/', 'path to logs directory')
...
tf.flags.DEFINE_string('initial_checkpoint', 'mobilenet_v1_1.0_224.ckpt', 'Path to the checkpoint file of the pretrained network.')
...
def main(argv=None):
    ...
    print 'resnet_v1_50/block4 : ',endpoints['Conv2d_12_pointwise']# (bt,7,7,2048)
