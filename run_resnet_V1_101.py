...
tf.flags.DEFINE_string('logs_dir', 'logs_RES101/', 'path to logs directory')
...
tf.flags.DEFINE_string('initial_checkpoint', 'resnet_v1_101.ckpt', 'Path to the checkpoint file of the pretrained network.')
...
def main(argv=None):
    ...
    model = import_module('nets.' + 'resnet_v1_101')
    ...
    print 'resnet_v1_101/block4 : ',endpoints['resnet_v1_101/block4']# (bt,7,7,2048)
    ...
    feat = endpoints['resnet_v1_101/block4']# (bt,7,7,2048)
